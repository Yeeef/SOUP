...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','yacc_demo.py',8),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','yacc_demo.py',12),
  ('expression -> term','expression',1,'p_expression_term','yacc_demo.py',16),
  ('term -> term TIMES factor','term',3,'p_term_times','yacc_demo.py',20),
  ('term -> term DIVIDE factor','term',3,'p_term_div','yacc_demo.py',24),
  ('term -> factor','term',1,'p_term_factor','yacc_demo.py',28),
  ('factor -> NUMBER','factor',1,'p_factor_num','yacc_demo.py',32),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','yacc_demo.py',36),
]
